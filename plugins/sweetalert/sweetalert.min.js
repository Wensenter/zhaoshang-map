! function(e, t, n) {
	...
	! function o(e, t, n) {
		...
		4: [function(n, o, a) {
			...
			var r = function(e, t) {
				...
				u = function(e) {
					...
					if($(".sweet-alert .info-add").css("display")=="none"){
					   
					    $(".info-add").parent().removeClass("info-tip");
					}else if($(".sweet-alert .info-add").css("display")=="block"){
					    
					    $(".info-add").parent().addClass("info-tip");
					};
					$(".sweet-close").click(function () {
		...
		7: [function(e, t, n) {
			...
			var o = '<div class="sweet-overlay" tabIndex="-1"></div><div class="sweet-alert"><a class="sweet-close"></a><div class="prompt-message"></div><div class="sweet-warpper clearfix"><div class="sa-icon sa-error">\n      <span class="sa-x-mark">\n        <span class="sa-line sa-left"></span>\n        <span class="sa-line sa-right"></span>\n      </span>\n    </div><div class="sa-icon sa-warning">\n      <span class="sa-body"></span>\n      <span class="sa-dot"></span>\n    </div><div class="sa-icon sa-info"></div><div class="sa-icon sa-success">\n      <span class="sa-line sa-tip"></span>\n      <span class="sa-line sa-long"></span>\n\n      <div class="sa-placeholder"></div>\n      <div class="sa-fix"></div>\n    </div><div class="sa-icon sa-custom"></div><div class="main"><h2>Title</h2>\n    <p>Text</p></div></div>\n    <fieldset>\n      <input type="text" tabIndex="3" />\n      <div class="sa-input-error"></div>\n    </fieldset><div class="sa-error-container">\n      <div class="icon">!</div>\n      <p>Not valid!</p>\n    </div><div class="sa-button-container">\n      <button class="cancel" tabIndex="2">取消</button>\n      <button class="confirm" tabIndex="1">OK</button>\n    </div></div>';
			n["default"] = o, t.exports = n["default"]
		}, {}],
		8: [function(e, t, o) {
			...
			var a = e("./utils"),
				r = e("./handle-swal-dom"),
				s = e("./handle-dom"),
				l = ["error", "warning", "info", "success", "input", "prompt","custom"],
				i = function(e) {
					var t = r.getModal(),
			 ...
			 promptMessage=t.querySelector("div.prompt-message"); //添加标题的提示文字和信息
			 promptMessage.innerHTML=e.promptMessage;
					...
					if(s.hide(t.querySelectorAll(".sa-icon")), e.type && !a.isIE8()) {
						var f = function() {
							...
							var i = ["success", "error", "warning", "info","custom"],
					...
					// 判断confirmButtonColor的颜色值是否为默认，如果不是就设置成是
					if(e.confirmButtonColor.length<1){
						e.confirmButtonColor="#5184ee"
					}
